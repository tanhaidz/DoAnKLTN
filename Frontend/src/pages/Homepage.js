...
class Homepage extends Component {
  ...
  componentDidUpdate(prevProps,prevState) {
    if (prevState.top10Objects !== this.state.top10Objects) {
      this.setState({ top10Objects: this.state.top10Objects });
    }
  ...
  getSaleProducts = () => {
    ...
    const top10Objects = products.slice(0, 10);
    this.setState({
              ...
              <div className="container section_best_deal ">
                <div className="border-red">
                  <div className="block-title">
                    <h2>
                      <a href="https://sfresh.w2.exdomain.net/san-pham" title=" Ưu đãi trong tuần">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.548 511.548" xmlSpace="preserve" width={512} height={512}>
                          <g>
                  ...
                  <div className="block-product">
                    ...
                    >
                      {top10Objects && top10Objects.length > 0 && top10Objects.map((item, i) => {
                        return (
                          <>
                            <SwiperSlide>
